...
def main():
    ...
    if args.demo:
        ...
        demo_slides = [
            ...
            {
                'type': 'testimonial',
                'quote': 'Acme Analytics replaced 3 tools and 2 contractors. Our content output tripled while costs dropped 60%.',
                'author': 'Sarah Chen',
            ...
            },
            {
                ...
                'contact': 'hello@acme-analytics.example',
                'website': 'acme-analytics.example'
            }
        ]

        html = generate_deck(demo_slides, "Acme Analytics - Pitch Deck")
