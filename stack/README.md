...
|-------|------|--------------|
| 🧠 **Knowledge** | [`ui-ux-pro-max`](https://github.com/nicohodt/claude-code-ui-ux-skill) | 84 UI styles, 192 color palettes, 73 font pairings, 99 UX rules, Core Web Vitals, 22 stacks — searchable, turned into a concrete design system |
