...
Instead, report it privately using [GitHub's private vulnerability reporting](https://github.com/nicohodt/claude-code-ui-ux-skill/security/advisories/new) (Security tab → "Report a vulnerability").
